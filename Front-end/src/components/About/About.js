        ...
        <div className="row">
          <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div className="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
              ...
              <h3>Всичко започна с няколко рецепти, а се превърна в нашия кулинарен рай.</h3>
              <p> Ние готвим с много любов и творим. Обичаме здравословната храна, тази която се приготвя бързо и е вкусна. </p>

              <p> Тук ще намерите разнообразни рецепти от традиционната българска кухня, които ние с голямо желание споделяме с ВАС. </p>

              <p> Отворени сме за вашите предложения за още невероятни вкусни рецепти.</p>

              <p>Бъдeте част от нашето семeйството.</p>
            </div>
          </div>
          <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div className="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
